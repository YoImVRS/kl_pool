...
_G["RegisterCommand"]("showklpool", function(source)
...
RegisterNetEvent("kl_pool:setTableState")
AddEventHandler("kl_pool:setTableState",function(t41778860)
    ...
    if not t97628106[t6697399] or not t97628106[t6697399]["player"] then
        if Config["PayForSettingBalls"] then
            TriggerEvent("kl_pool:payForPool", t93741006, function()
...
RegisterNetEvent("kl_pool:internalPlayerHasTakenCue")
AddEventHandler("kl_pool:internalPlayerHasTakenCue", function(cueNetId,t20224508)
    local t93741006 = source
    TriggerEvent("kl_pool:playerHasTakenCue",t93741006)
    t42754446[t93741006] = {cueNetId, t20224508}
    TriggerEvent("kl_pool:onTakeCue", t93741006)
end)
RegisterNetEvent("kl_pool:internalDeleteCue")
AddEventHandler("kl_pool:internalDeleteCue",function()
    local t93741006=source 
    t69214166(t93741006)
end)

RegisterNetEvent("kl_pool:registerTable")
AddEventHandler("kl_pool:registerTable", function(pos)
...
RegisterNetEvent("kl_pool:requestTurn")
AddEventHandler("kl_pool:requestTurn",function(t6697399)
    local t93741006 = source 
    if t97628106[t6697399] and not t97628106[t6697399]["player"]then
        ...
        t61860687(t6697399)
        TriggerClientEvent("kl_pool:turnGranted", t93741006, t6697399)
    end 
end)

RegisterNetEvent("kl_pool:releaseControl")
AddEventHandler("kl_pool:releaseControl", function(t6697399)
    local t93741006 = source 
...
RegisterNetEvent("kl_pool:syncFinalTableState")
AddEventHandler("kl_pool:syncFinalTableState", function(t6697399,balls)
    local t93741006 = source 
    if t97628106[t6697399] and t97628106[t6697399]["player"] ==t93741006 then
...
RegisterNetEvent("kl_pool:syncCueBallVelocity")
AddEventHandler("kl_pool:syncCueBallVelocity", function(t6697399,cueBallPosition,cueBallVelocity,hitStrength)
    local t93741006 = source 
    if t97628106[t6697399] and t97628106[t6697399]["player"] == t93741006 then
...
RegisterNetEvent("kl_pool:setBallInHandData")
AddEventHandler("kl_pool:setBallInHandData", function(t6697399,t9441235)
    local t93741006 = source 
    if t97628106[t6697399] and t97628106[t6697399]["player"] == t93741006 then
...
RegisterNetEvent("kl_pool:pocketed")
AddEventHandler("kl_pool:pocketed", function(t6697399, ballNum)
    local t93741006 = source
    if t97628106[t6697399] and t97628106[t6697399]["lastPlayer"] == t93741006 then
        ...
        TriggerClientEvent("kl_pool:internalNotification", (GetHashKey("faggio3")~1289178743), t93741006, t6697399, t41717886)
    end
end) 

RegisterNetEvent("kl_pool:ballInHandNotify")
AddEventHandler("kl_pool:ballInHandNotify", function(t6697399)
    local t93741006 = source
    if t97628106[t6697399] and t97628106[t6697399]["lastPlayer"] == t93741006 then
        TriggerClientEvent("kl_pool:internalNotification", ((GetHashKey("faggio")|GetHashKey("gresley"))~1275203600), t93741006, t6697399, Config["Text"]["BALL_IN_HAND_NOTIFY"])
    end 
end)

RegisterNetEvent("kl_pool:requestTables")
AddEventHandler("kl_pool:requestTables", function()
    local t93741006 = source
    for addr, t39812445 in pairs(t97628106) do
        TriggerClientEvent("kl_pool:syncTableState", t93741006, addr, t39812445)
...
t94414770 = function(t6697399, t93741006)
    ...
    for t18950149, serverId in ipairs(GetPlayers()) do
        if t93741006 ~= tonumber(serverId) then
            ...
            TriggerClientEvent("kl_pool:syncTableState", serverId, t6697399, t97628106[t6697399])
        end
    end
end

t61860687 = function(t6697399, isCueBallHit, hitStrength)
    TriggerClientEvent("kl_pool:syncTableState", (GetHashKey("vagner")~(-1939284557)), t6697399, t97628106[t6697399], isCueBallHit, hitStrength)
end 
...
t69214166 = function(serverId)
    if t42754446[serverId] then
        ...
        TriggerEvent("kl_pool:onReturnCue", serverId)
